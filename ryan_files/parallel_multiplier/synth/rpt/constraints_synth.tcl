...
# 500 MHz, since 1 GHz couldn't meet timing
# 400 MHz, since 500 MHz couldn't meet timing
# 300 MHz, since 400 MHz couldn't meet timing
set CLK_PER  3.33
set CLK_SKEW 0.05
...
set fanout          1
set port_load [expr $wire_load_est + $fanout * [load_of $port_load_cell] * 800]
